...
export const LogItem = ({log, index}) => {
    ...
    return (
        <div key={index} className="flex items-center justify-between px-4 py-3 border-b border-gray-300 last:border-b-0 bg-white hover:bg-gray-100 transition-colors duration-300">
