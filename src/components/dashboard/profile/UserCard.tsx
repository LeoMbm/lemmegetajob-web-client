...
export const UserCard = () => {
    ...
    if (isLoading) {
        return <div className='p-4 w-full flex justify-center items-center'>
  ...
  return (
    ...
    <div className="px-6 py-4">
        ...
        <div className="flex items-center mt-4 text-gray-700 dark:text-gray-200">
            ...
            <h1 className="px-2 text-sm">{user.current_position}</h1>
        </div>
        ...
        <div className="flex items-center mt-4 text-gray-700 dark:text-gray-200">
            ...
            <h1 className="px-2 text-sm">{user.current_location}</h1>
        </div>
